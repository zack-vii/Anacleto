...
/* make sequence */
    ...
    return(w7x_timing_lib->makeSequence(ref(_delay),ref(_width),ref(_period),ref(_burst),ref(_cycle),ref(_repeat),ref(_count),ref(_times)));
  } ELSE {
/* make clock */
    return(w7x_timing_lib->makeClock(ref(_delay),ref(_width),ref(_period),ref(_burst),ref(_cycle),ref(_repeat)));
  }   
}
