create_clock -period 100 -name clk_in  -waveform {0 50} [get_ports {clk_ext_in}]
create_clock -period 100 -name clk_int -waveform {0 50} [get_ports {clk_int_in}]
...
set_clock_groups -name async -asynchronous -group {clk_in} -group {clk_int}
